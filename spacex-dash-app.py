...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # Count the occurrences of each class (0 for Failure, 1 for Success)
        class_counts = site_filtered_df['class'].value_counts().reset_index()
...
def update_scatter_chart(selected_site, payload_range):
    ...
    if selected_site == 'ALL':
        ...
        fig = px.scatter(
            ...
            title='Correlation between Payload and Mission Outcome (All Sites)'
        )
    else:
        ...
        fig = px.scatter(
            ...
            y='class',
            color='Booster Version Category',
            title=f'Correlation between Payload and Mission Outcome ({selected_site})'
        )
